...
var _excluded = ["retry", "retryDelay", "withCredentials", "headers", "timeout", "baseURL"],
    _excluded2 = ["url", "method", "params", "data", "instance"];
...
var _configRequestInterceptor = function _configRequestInterceptor(instance, requestInterceptorSuccessCb) {
  instance.interceptors.request.use(function (config) {
    if (requestInterceptorSuccessCb) {
      ...
      if (!_type["default"].isObject(_config)) {
...
var _configResponseInterceptor = function _configResponseInterceptor(instance, responseInterceptorSuccessCb, responseInterceptorErrorCb, retry, retryDelay) {
  ...
  instance.interceptors.response.use(function (res) {
    if (responseInterceptorSuccessCb) {
      ...
      if (!_type["default"].isObject(_res)) {
        throw Error("responseInterceptorSuccessCb必须返回一个response对象");
      }

      console.log("%c".concat("[HTTP]", " %c", (0, _dayjs["default"])().format("HH:mm:ss"), " %c").concat(res.config.method.toLocaleUpperCase(), " %c").concat("/" + res.config.url.split("/")[res.config.url.split("/").length - 1], "(%c").concat(res.status) + "%c)", "font-weight:bold", "font-weight:bold", "font-weight:bold", "font-weight:bold", "color:".concat(res.status === 200 ? "#67C23A" : "#F56C6C", ";font-weight:bold"), "font-weight:bold");
      return _res;
    }
    ...
    if (config.__retryCount >= config.retry) {
      ...
      if (responseInterceptorErrorCb) {
        ...
        if (!_type["default"].isObject(err === null || err === void 0 ? void 0 : err.config)) {
  ...
  _createClass(Fetch, null, [{
    ...
    value: function create() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          expand = _objectWithoutProperties(_ref, _excluded);
    ...
    value: function axios() {
      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          expand = _objectWithoutProperties(_ref2, _excluded2);
